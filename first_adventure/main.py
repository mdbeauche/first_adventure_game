#!C:\Users\michael\My Projects\Python27\python.exe
...
def main():
    ...
    pygame.display.set_icon( pygame.image.load( os.path.join( os.pardir, DATA, WINDOW_ICON ) ).convert() ) # 32x32
    ...
    pygame.mixer.music.play( -1, 23.0 )
