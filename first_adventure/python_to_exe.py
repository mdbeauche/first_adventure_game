...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "first_adventure"
        ...
        #Auhor of program
        self.author_name = "Michael Beauchemin"
        self.author_email = "michael.beauchemin@gmail.com"
        ...
        self.extra_datas = [ os.path.join( os.curdir, os.pardir, 'data', 'catImg.png' ),
                             os.path.join( os.curdir, os.pardir, 'data', 'bearImg.png' ),
                             os.path.join( os.curdir, os.pardir, 'data', 'SmBearTlBearCatSheet.png' ),
                             os.path.join( os.curdir, os.pardir, 'data', 'song.ogg' ),
                             os.path.join( os.curdir, os.pardir, 'data', 'death.wav' ),
                             os.path.join( os.curdir, os.pardir, 'data', 'fire.wav' ),
                             os.path.join( os.curdir, os.pardir, 'data', 'killed.wav' ),
                             os.path.join( os.curdir, os.pardir, 'data', 'high_score.txt' )]
